...
namespace lesma {
    ...
    public:
        ...
        virtual std::string toString(SourceManager *srcMgr, const std::string &prefix, bool isTail) const {
    ...
    public:
        ...
        std::string toString(SourceManager * /*srcMgr*/, const std::string & /*prefix*/, bool /*isTail*/) const override {
