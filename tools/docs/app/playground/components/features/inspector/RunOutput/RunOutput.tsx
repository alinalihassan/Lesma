...
import { Console, type ConsoleProps } from '@/playground/components/features/inspector/Console/Console'
import { FallbackOutput } from '@/playground/components/features/inspector/FallbackOutput/FallbackOutput'
import { ProblemsList } from '@/playground/components/features/inspector/RunOutput/ProblemsList'
import type { InspectorOutputTab, State } from '@/playground/store/state'
import { DEFAULT_FONT, getDefaultFontFamily, getFontFamily } from '@/playground/services/fonts'
