...
import { type DocumentState, type EditorPreferences, type MonacoEditorProps } from '@/playground/lib/editor/props'
import { EventType } from '@/playground/lib/editor/types/events'
import { Syntax } from '@/playground/lib/editor/types/common'
