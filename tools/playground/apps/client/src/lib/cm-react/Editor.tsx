...
export class Editor extends React.Component<EditorProps, State> {
  ...
  constructor(props: EditorProps) {
    ...
    const { store, preferences, value, lspExtensions } = props
    ...
    this.extensions = [
      ...
      this.lspCompartment.of(lspExtensions ?? []),
  ...
  componentDidUpdate(prevProps: Readonly<EditorProps>) {
    ...
    if (prevProps.lspExtensions !== this.props.lspExtensions) {
      this.editor.dispatch({
        effects: this.lspCompartment.reconfigure(this.props.lspExtensions ?? []),
      })
    }
