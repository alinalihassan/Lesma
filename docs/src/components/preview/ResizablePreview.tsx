...
import PanelHeader from '@site/src/components/core/Panel/PanelHeader';
import {LayoutType, DEFAULT_PANEL_HEIGHT, DEFAULT_PANEL_WIDTH} from '@site/src/styles/layout';
